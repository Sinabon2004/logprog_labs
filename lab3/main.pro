...
domains
    genre =
        развлекательный; научный; бытовой; новостной; путешествия; фантастика; спортивный; технический; компьютерный; детский; бизнес; мода;
        автомобильный; кулинария; исторический; здоровье; экономический; военный; литературный; медицинский.
...
clauses
    ...
    run() :-
        ...
        X = "Комсомольская правда",
        write(X, ': '),
        L = доставка("Комсомольская правда"),
        write_string(L),
        fail.
